...
export const metadata: Metadata = {
    ...
    openGraph: {
        title: 'Mahziyar Erfani | Portfolio',
        description: "Learn about Mahziyar Erfani's journey in web development and design, explore his projects, and stay updated through his blog, where he shares insights and experiences from his work.",
        images: [
            {
