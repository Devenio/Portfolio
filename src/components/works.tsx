            ...
            <div className="relative flex flex-col lg:flex-row items-center justify-center">
                ...
                <div className="relative flex flex-col md:max-w-lg lg:w-96 pt-5 pb-5 pr-4 lg:px-9 lg:pt-10 border-theme-accent lg:border-2 lg:right-28 rounded-3xl z-10">
                    ...
                    <Link
                        ...
                        className={`text-center bg-theme-primary hoverable  transition-all delay-0   hover:tracking-widest font-bold text-theme-background text-sm px-6 py-2 rounded-xl ${isTransitioning ? '' : 'z-30 relative'
                            }`}
                    >
                        Visit
                    </Link>
                    ...
                    <div className="absolute inset-0 h-full rounded-3xl mt-1 lg:mt-0 lg:overflow-hidden z-10">
                        {overlayColors.map((color, index) => (
                            <motion.div
                                ...
                                className={`absolute lg:rounded-3xl inset-0 h-full ${color} z-[${20 - index
                                    }]`}
                                style={{ originX: 0 }}
                            />
                        ))}
