...
>['components'] = {
    ...
    h2: (props: React.HTMLAttributes<HTMLHeadingElement>) => (
        <h2
            className="text-2xl font-bold text-theme-secondary mt-14 mb-4"
            {...props}
        />
    ),
    ...
    ul: (props: React.HTMLAttributes<HTMLUListElement>) => (
        <ul className="list-disc text-theme-secondary my-4" {...props} />
    ),
    ol: (props: React.HTMLAttributes<HTMLOListElement>) => (
        <ol className="list-decimal text-theme-secondary my-4" {...props} />
    ),
    li: (props: React.HTMLAttributes<HTMLLIElement>) => (
        <li className="text-theme-secondary my-2" {...props} />
    ),
